...
class CellColUnPopular: UICollectionViewCell,UIGestureRecognizerDelegate {
    ...
    func setUI(objNowPlay : Results?){
        ...
        let posterPath =  objNowPlay?.posterPath ?? ""
        ...
        self.layoutIfNeeded()
        self.lblTitle.text = objNowPlay?.originalTitle
        self.lblDescription.text = objNowPlay?.overview
    }
